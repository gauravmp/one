...
-- Command     : write_vhdl -force -mode funcsim {E:/HASP/GRID
--               Redesign/Code/Preprocessing2/Preprocessing2.srcs/sources_1/ip/pll1/pll1_sim_netlist.vhdl}
-- Design      : pll1
...
entity pll1_pll1_clk_wiz is
  ...
  attribute ORIG_REF_NAME of pll1_pll1_clk_wiz : entity is "pll1_clk_wiz";
end pll1_pll1_clk_wiz;

architecture STRUCTURE of pll1_pll1_clk_wiz is
  signal clk_in1_pll1 : STD_LOGIC;
  signal clk_out1_pll1 : STD_LOGIC;
  signal clk_out1_pll1_en_clk : STD_LOGIC;
  signal clk_out2_pll1 : STD_LOGIC;
  signal clk_out2_pll1_en_clk : STD_LOGIC;
  signal clk_out3_pll1 : STD_LOGIC;
  signal clk_out3_pll1_en_clk : STD_LOGIC;
  signal clk_out4_pll1 : STD_LOGIC;
  signal clk_out4_pll1_en_clk : STD_LOGIC;
  signal clkfbout_buf_pll1 : STD_LOGIC;
  signal clkfbout_pll1 : STD_LOGIC;
...
entity pll1 is
  ...
  attribute NotValidForBitStream of pll1 : entity is true;
end pll1;

architecture STRUCTURE of pll1 is
begin
inst: entity work.pll1_pll1_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
