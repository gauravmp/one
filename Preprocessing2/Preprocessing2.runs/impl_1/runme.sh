...
HD_PWD='E:/HASP/GRID Redesign/Code/Preprocessing2/Preprocessing2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log preprocessing_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source preprocessing_top.tcl -notrace
