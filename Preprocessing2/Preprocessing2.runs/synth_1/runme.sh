...
HD_PWD='E:/HASP/GRID Redesign/Code/Preprocessing2/Preprocessing2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log preprocessing_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source preprocessing_top.tcl
