...
HD_PWD='E:/HASP/GRID Redesign/Code/Preprocessing2/Preprocessing2.runs/pll1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pll1.tcl
